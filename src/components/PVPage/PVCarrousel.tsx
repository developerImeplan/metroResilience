  ...
  return (
    <div className="container mx-auto px-4 pt-[65px]">
      ...
      <div className="sm:pl-5">
        ...
        >
          <BannerTitle 
            title={PV_CARROUSEL[currentIndex].title}
            subtitle={PV_CARROUSEL[currentIndex].subtitle}
          />
        </div>
      </div>

      {/* Contenedor principal del carrusel */}
      <div className="flex items-center mt-10 min-h-[400px] sm:min-h-[400px]">
        {/* Botón izquierda */}
        <button
          onClick={handlePrev}
...
const PV_CARROUSEL: PVCarrouselProps[] = [
  {
    ...
    subtitle: "San Pedro Tlaquepaque",
