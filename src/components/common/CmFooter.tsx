  ...
  return(
    <div className="w-full bg-[#31365c] sm:px-10 pt-10">
      <div className="flex sm:flex-row flex-col items-center sm:space-x-5">
        ...
        <div className="flex justify-around sm:w-1/3 sm:pl-20 sm:space-x-0 space-x-5">
          {CM_ICONS_SN.map(i => <CmIconSN {...i} />)}
        </div>
      </div>
      <p className="text-center text-xs text-white font-thin sm:mb-0 mb-5 py-10 sm:px-20 px-10">
